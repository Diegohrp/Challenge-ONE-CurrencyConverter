...
public enum Coins implements Enumerable {
    ...
    MXN(new Measurement("MXN",'$',"Peso Mexicano","mx.png"),new HashMap<String,Double>(){{
        put("MXN",1.0);
        put("EUR",0.054);
        put("USD",0.059);
        put("GBP",0.046);
    ...
    EUR(new Measurement("EUR",'€',"Euro","eur.png"),new HashMap<String,Double>(){{
        put("MXN",18.63);
        put("EUR",1.0);
        put("USD",1.10);
        put("GBP",0.86);
    ...
    USD(new Measurement("USD",'$',"Dólar estadounidense","usa.png"),new HashMap<String,Double>(){{
        put("MXN",17.01);
        put("EUR",0.91);
        put("USD",1.0);
        put("GBP",0.79);
    ...
    GBP(new Measurement("GBP",'£',"Libra esterlina","uk.png"),new HashMap<String,Double>(){{
        put("MXN",21.59);
        put("EUR",1.16);
        put("USD",1.27);
        put("GBP",1.0);
    ...
    JPY(new Measurement("JPY",'¥',"Yen japonés","japan.png"),new HashMap<String,Double>(){{
        put("MXN",0.12);
        put("EUR",0.0063);
        put("USD",0.0069);
        put("GBP",0.0054);
    ...
    KRW(new Measurement("KRW",'₩',"Won surcoreano","kor.png"),new HashMap<String,Double>(){{
        put("MXN",0.013);
        put("EUR",0.00069);
        put("USD",0.00075);
        put("GBP",0.00059);

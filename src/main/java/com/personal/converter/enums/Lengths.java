...
public enum Lengths implements Enumerable {
    ...
    cm(new Measurement("m",'m',"Metros"),new HashMap<String,Double>(){{
        put("m",0.01);
        put("cm",1.0);
        put("km",1e-5);
        put("mm",10.0);
    ...
    km(new Measurement("m",'m',"Metros"),new HashMap<String,Double>(){{
        put("m",1000.0);
        put("cm",100000.0);
        put("km",1.0);
        put("mm",1e+6);
    ...
    mm(new Measurement("m",'m',"Metros"),new HashMap<String,Double>(){{
        put("m",0.001);
        put("cm",0.1);
        put("km",1e-6);
        put("mm",1.0);
    ...
    mi(new Measurement("m",'m',"Metros"),new HashMap<String,Double>(){{
        put("m",1609.34);
        put("cm",160934.0);
        put("km",1.60934);
        put("mm",1.609e+6);
    ...
    ft(new Measurement("m",'m',"Metros"),new HashMap<String,Double>(){{
        put("m",0.3048);
        put("cm",30.48);
        put("km",0.0003048);
        put("mm",304.8);
    ...
    yd(new Measurement("m",'m',"Metros"),new HashMap<String,Double>(){{
        put("m",0.9144);
        put("cm",91.44);
        put("km",0.0009144);
        put("mm",914.4);
